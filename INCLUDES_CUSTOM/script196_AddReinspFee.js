...
function script196_AddReinspFee() {
	...
	try { 
		if (wfStatus == "Reinspection Required") {
			emailContact("template for script test", "Please schedule another inspection       This is a system generated email. Do not reply.", "Applicant");
			emailContact("template for script test", "Please schedule another inspection       This is a system generated email. Do not reply.", "Owner");
