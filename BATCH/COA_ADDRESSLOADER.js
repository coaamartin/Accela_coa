...
*/
lineFormat = ["PARCEL_NO", "DESCRIPTION","HOUSE_NUMBER_START","STREET_DIRECTION","STREET_NAME","STREET_SUFFIX","STREET_SUFFIX_DIRECTION","UNIT_START","UNIT_TYPE","CITY","STATE","ZIP","COUNTY","COUNTRY","FULL_ADDRESS","STATUS","ADDRESS_TYPE","ADDRESS_TYPE_FLAG","PRIMARY_FLAG","VALIDATE_FLAG","TEMPLATE_NAME_1" , "ATTRIBUTE_NAME_1" , "ATTRIBUTE_VALUE_1" , "TEMPLATE_NAME_2" , "ATTRIBUTE_NAME_2" , "ATTRIBUTE_VALUE_2","DISTANCE", "EVENT_ID", "HOUSE_FRACTION_END", "HOUSE_FRACTION_START","HOUSE_NUMBER_ALPHA_END", "HOUSE_NUMBER_ALPHA_START", "HOUSE_NUMBER_END",  "INSPECTION_DISTRICT", "INSPECTION_DISTRICT_PREFIX","LEVEL_NUMBER_END", "LEVEL_NUMBER_START", "LEVEL_PREFIX", "NEIGHBERHOOD_PREFIX", "NEIGHBORHOOD",  "SECONDARY_ROAD", "SECONDARY_ROAD_NUMBER","SOURCE_FLAG",    "STREET_PREFIX","UNIT_END",    "X_COORDINATOR", "Y_COORDINATOR",   "ADDRESS_LINE_1", "ADDRESS_LINE_2","TEMPLATE_NAME_3" , "ATTRIBUTE_NAME_3" , "ATTRIBUTE_VALUE_3","TEMPLATE_NAME_4" , "ATTRIBUTE_NAME_4" , "ATTRIBUTE_VALUE_4", "TEMPLATE_NAME_5" , "ATTRIBUTE_NAME_5" , "ATTRIBUTE_VALUE_5"];
