...
/------------------------------------------------------------------------------------------------------*/
//aa.env.setValue("paramStdChoice","BATCH_REPORT_WITH_NO_PARAM");
//aa.env.setValue("eventType","Batch Process");
//aa.env.setValue("BatchJobName","BATCH_REPORT_WITH_NO_PARAM");
/*------------------------------------------------------------------------------------------------------/
| Program: BATCH_REPORT_WITH_NO_PARAM 
| Trigger: Batch
| Client: COA
|
|
...
function mainProcess() {
	...
	logdebut("Gen report", reportName)
