...
function updateCustomFieldAndScheduleInspection() {
    ...
    for (r in capIdScriptModelList) {
        ...
        if (inspectionMonth == null || inspectionMonth == "") {
            logDebug("**INFO Working on capId=" + capId.getId() + ", altId= " + capId.getCustomID() + " Inspection Month is null, SKIP...");
            continue;
        }
        ...
        if (inspectionMonth.indexOf(nextMonthNumber) != -1) {
            ...
            if (inspectionFrequency == null || inspectionFrequency == "") {
                logDebug("**WARN Working on capId=" + capId.getId() + ", altId= " + capId.getCustomID() + "Inspection Frequency is null, SKIP...");
                continue;
            }
            ...
            logDebug("**INFO Working on capId=" + capId.getId() + ", altId= " + capId.getCustomID() + " // inspectionFrequency=" + inspectionFrequency + " // inspectionMonth=" + inspectionMonth);
