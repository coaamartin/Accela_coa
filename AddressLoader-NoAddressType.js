/*------------------------------------------------------------------------------------------------------/
| Program: ReferenceAddressLoaderWithUID  Trigger: Batch    
...
"EXT_UID", "TEMPLATE_NAME_1" , "ATTRIBUTE_NAME_1" , "ATTRIBUTE_VALUE_1" , "TEMPLATE_NAME_2" , "ATTRIBUTE_NAME_2" , "ATTRIBUTE_VALUE_2" , 
			...
			for (pIndex in pieces) {
				...
				switch (pieceDataName) {
					...
					case "ADDRESS_LINE_2":
						...
						break;
					case "EXT_UID":
							newAddr.setUID(String(pieceValue).trim());
						break;
