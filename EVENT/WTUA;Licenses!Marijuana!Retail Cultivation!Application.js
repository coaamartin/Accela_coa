if(ifTracer(wfTask == "License Issuance" && wfStatus == "Issued", 'wf:License Issuance/Issued')){
    ...
    if(newLicCapId){
        ...
        scheduleInspectionWithCapIdBusinessDays("MJ Building Inspections - Electrical", 84, "DALLEN", " ", "Scheduled by Script 229", newLicCapId);
        scheduleInspectionWithCapIdBusinessDays("MJ Building Inspections - Mechanical", 84, "DALLEN", " ", "Scheduled by Script 229", newLicCapId);
        scheduleInspectionWithCapIdBusinessDays("MJ Building Inspections - Life Safety", 84, "DALLEN", " ", "Scheduled by Script 229", newLicCapId);
        scheduleInspectionWithCapIdBusinessDays("MJ Building Inspections - Structural", 84, "DALLEN", " ", "Scheduled by Script 229", newLicCapId);
