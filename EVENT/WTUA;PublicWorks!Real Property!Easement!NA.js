...
var $iTrc = ifTracer;
/*
Title : Set Plans Coordination to Resubmittal Requested (WorkflowTaskUpdateAfter)
...
update the workflow task "Plans Coordination" with a status of "Resubmittal Requested" and send an email
...
Sample Call:
checkWorkFlowTaskAndSendEmail("Review Distribution","Route for Review",["Engineering Review", "Water Dept Review"], "Plans Coordination", "Resubmittal Requested", "Complete", "MESSAGE_NOTICE_PUBLIC WORKS");
 */
...
var taskToUpdated = "Plans Coordination";
 ...
 */
//Script 162
if(matches(wfTask, "Plans Coordination", "Plans Coordination") && wfStatus == "Ready for Signatures"){
