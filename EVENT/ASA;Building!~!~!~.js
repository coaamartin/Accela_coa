...
if(!appMatch("Building/Permit/New Building/NA") && !appMatch("Building/Permit/OTC/*") && !appMatch("Building/Permit/TempSigns/*")&& !appMatch("Building/Permit/TempUse/*")&& !appMatch("Building/Permit/DonationBin/*") && !appMatch("Building/Permit/Master/*")&& !appMatch("Building/Permit/New Building/Amendment")&& !appMatch("Building/Permit/Plans/NA"))
