logDebug("***** Starting SEND_EMAIL_TS_ASYNC *****");
...
try
{
    ...
    tParams.put("$$Record Type$$", "Temporary Sign Permit");
	...
	var report = generateReportFile("Temp_Sign_Permit_script", rParams, aa.getServiceProviderCode());
