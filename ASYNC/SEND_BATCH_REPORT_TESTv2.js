...
logDebug("***** Starting SEND_BATCH_REPORT_TESTv2 from script *****");
try
{
	var reportName = aa.env.getValue("reportName");
    var emailTo = aa.env.getValue("emailSendTo");
	...
	// if ("Fire Primary Inspection".equals(reportName))
	// {		
    ...
    var report = generateReportFile(reportName, "", aa.getServiceProviderCode());
