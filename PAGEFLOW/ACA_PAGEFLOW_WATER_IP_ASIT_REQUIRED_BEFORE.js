/*------------------------------------------------------------------------------------------------------/
| Program : ACA_PAGEFLOW_WATER_IP_ASIT_REQUIRED_BEFORE
...
if (typeof(GENERALINFORMATION) == "object"){
...
rowCount = GENERALINFORMATION.count(); // row count
}
...
if (rowCount < 1){
	...
	message = "You must enter at least one (1) row."; 
}
