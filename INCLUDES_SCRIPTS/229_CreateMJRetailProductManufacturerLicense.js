...
if (wfTask == "License Issuance" && wfStatus == "Issued") {
	...
	if (appTypeArray[3] == "Application" && (vParentArry == null || vParentArry == "")) {
		...
		tmpCap = capId;
		capId = vLicenseID;
		updateTask("License Status", "Active", "Updated by Script 229_CreateMJRetailProductManufacturerLicense", "Update by Script 229_CreateMJRetailProductManufacturerLicense");
		capId = tmpCap;
		...
		if (appMatch("Licenses/Marijuana/Retail Product Manufacturer/License", vLicenseID) && (wfStatus == "Issued")) {
			vEmailTemplate = "LIC MJ APPROVAL OF LICENSE #226 - 230";
			vReportTemplate = "MJ_License";
			tmpCap = capId;
			capId = vLicenseID;
			scheduleInspection("MJ AMED Inspections", 77, "DALLEN", " ", "Scheduled by Script 229");
			scheduleInspection("MJ Building Inspections - Plumbing", 77, "SLCLARK", " ", "Scheduled by Script 229");
			scheduleInspection("MJ Building Inspections - Electrical", 77, "SLCLARK", " ", "Scheduled by Script 229");
			scheduleInspection("MJ Building Inspections - Mechanical", 77, "SLCLARK", " ", "Scheduled by Script 229");
			scheduleInspection("MJ Building Inspections - Life Safety", 77, "SLCLARK", " ", "Scheduled by Script 229");
			scheduleInspection("MJ Security Inspections - 3rd Party", 77, "JBEUTHEL", " ", "Scheduled by Script 229");
			scheduleInspection("MJ Building Inspections - Structural", 77, "SLCLARK", " ", "Scheduled by Script 229");
			capId = tmpCap;
		}
...
//End - 229 MJ Retail Product Manufacturer License Creation