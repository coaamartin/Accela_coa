    ...
    try{
        ...
        //if(ifTracer(checkForDups == "CHECKED", 'Checking for duplicates')){
            ...
            for (cappy in capIdArray){
                ...
                if(relType.startsWith("Enforcement/") && matches(relStatus, "Monitoring","Assigned","Submitted","Working","No Plant","Planted","Removed","Complete Not Stake", "Complete Staked","Warranty Failed")){
