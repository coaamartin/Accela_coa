...
if (vLicenseId != null && vLicenseId != false) {
    ...
    vLicExp_mm = vExpDate.getMonth(); //Month less (no +1 for month)
    ...
    logDebug("Delinquent fee check. ACA submittal: " + cap.isCreatedByACA() + " Del Fee Date: " + vExpDateString + " Compare Date: " + vCompareDate);
    if (vCompareDate != null && vCompareDate != false) {
        //vCompareDate = new Date(vCompareDateString);
        if (vExpDate < vCompareDate) {
            logDebug("Assessing delinquent fee. ACA submittal: " + cap.isCreatedByACA() + " Del Fee Date: " + vExpDateString + " Compare Date: " + vCompareDate);
