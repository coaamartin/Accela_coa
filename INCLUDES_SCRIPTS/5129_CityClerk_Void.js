//Written by rprovinc   
//
//include("5125_CityClerk_Void.js");

//*****************************************************************************
//Script ASA;CityClerk!~!~!~.js
//Record Types:	CityClerk\Incident\*\* 
//Event: 		WTUA
//Desc:			Sending emails to citizen letting them know that there permit was voided.
//
//Created By: Rprovinc
//******************************************************************************
...
if ("Building/Permit/DonationBin/NA".equals(appTypeString)) {
    ...
    logDebug("End of Script 5129-Void");
