    ...
    "WorkflowTaskUpdateAfter": [
      {
        ...
        "postScript": "",
        "metadata": {
          "description": "To run automated script based on JSON rules - #226 - 230",
          "operators": {}
        },
        "criteria": {
          "task": [
        ...
        "action": {
          "notificationTemplate":  "LIC MJ APPROVAL OF LICENSE #226 - 230",
          "notificationReport": "",
          "notifyContactTypes": [
              "Applicant"
          ],
          "url4ACA": "",
          "fromEmail": "noreply@auroraco.gov",
          "additionalEmailsTo": ["Responsible Party"],
